...
export default function AddSchedule() {
    ...
    //add Actvities
    const [newSched, setNewSched] = useState([{action:"", time:""},]);
            ...
            <mui.Grid container  item xs={6} >
                    <form style={{width:"100%"}} onSubmit={handleSubmit}>
                        ...
                        <div style={{padding:"7px"}}>
                            {newSched.map((shed,index)=>(
                                <mui.Grid container key={index}>
                                    <mui.Grid item xs ={4} style={{padding:"5px"}}>
                                    <mui.TextField fullWidth select variant="outlined" name="action" label="Activity" InputLabelProps={{shrink: true}} value={shed.action} onChange={e => handleInput(e, index)}>
                                    ...
                                    <mui.Grid item xs={4} style={{padding:"5px"}}>
                                        <mui.TextField fullWidth variant="outlined" type="time" label="Time" name="time" InputLabelProps={{shrink: true}} value={shed.time} onChange={e => handleInput(e, index)}/>
                                    </mui.Grid>
                                    <mui.Grid item xs={4} style={{padding:"5px"}}>
